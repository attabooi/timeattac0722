...
class ApplyView(APIView):
    ...
    def post(self, request):
        ...
        apply_serialzer.status = "submitted"
    ...
    def get(self, request):
        ...
        status_id = JobStatus.objects.get(status=status)
        status_id = status_id.id
        job_post = JobPost.objects.filter(status_id=status_id)
        return Response(job_post)